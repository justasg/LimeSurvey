...
<?php
     ...
     <input type='submit' value="<?php $clang->eT("Go to question group") ?>" onclick="window.location='<?php echo $this->createUrl('admin/survey/sa/view/surveyid/'.$surveyid.'/gid/'.$aImportResults['newgid']) ?>'" />
</div><br />
