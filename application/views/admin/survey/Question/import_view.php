...
?>
    ...
    <input type='submit' value='<?php $clang->eT("Go to question") ?>' onclick="window.location='<?php echo $this->createUrl('admin/survey/sa/view/surveyid/' . $surveyid . '/gid/' . $gid . '/qid/' . $aImportResults['newqid']) ?>'" />
</div>