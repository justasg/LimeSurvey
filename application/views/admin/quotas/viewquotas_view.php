...
<tfoot>
    <tr>
        ...
        <td>&nbsp;</td>
        <td>&nbsp;</td>
        <td style="padding: 3px;"><input type="button" value="<?php $clang->eT("Quick CSV report");?>" onClick="window.location='<?php echo $this->createUrl("admin/quotas/sa/index/surveyid/$surveyid/quickreport/y") ?>'" /></td>
    </tr>
	</tfoot>
	<tbody>