...
<table style="width: 694px;">
 <tbody>
  <tr>
   ...
   <td align="right" style="width: 227px;"><input class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" type="submit" value="<?php $clang->eT("Administration"); ?>" onclick="javascript: window.location='<?php echo $this->createUrl("/admin"); ?>'" />
